...
class ATCChatMockStore {
    static let walkthroughs = [
        ATCWalkthroughModel(title: "Posts", subtitle: "Share posts, photos and comments with your network.", icon: "activity-feed-icon"),
        ATCWalkthroughModel(title: "Stories", subtitle: "Share stories that disappear after 24h.", icon: "camera-icon"),
        ATCWalkthroughModel(title: "Check in", subtitle: "Check in when posting to share your location with friends.", icon: "pinpoint-icon"),
        ATCWalkthroughModel(title: "Reactions", subtitle: "React to posts and photos with likes, dislikes and more.", icon: "thumbsup"),
        ATCWalkthroughModel(title: "Chat", subtitle: "Communicate with your friends via private messages.", icon: "social-chat-icon"),
        ATCWalkthroughModel(title: "Group Chats", subtitle: "Have fun with your gang with in group chats.", icon: "social-friends-tab-icon"),
        ATCWalkthroughModel(title: "Get Notified", subtitle: "Receive notifications when friends are looking for you.", icon: "bell-icon"),
        ]
